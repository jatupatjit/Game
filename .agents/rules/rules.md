...
- For comprehensive project architecture, active component details, rigging structure, and bug history, refer to [`.agents/context_handoff.md`](../context_handoff.md).
...
- At the conclusion of each milestone or major bug fix, automatically summarize the latest changes, resolved issues, and next tasks directly into [`.agents/context_handoff.md`](../context_handoff.md). Keep it concise under 300 words using bullet points.
